...
func InvalidClusterConfiguration(msg string, args ...interface{}) *ClusterError {
	return &ClusterError{
...
func CreateCluster(msg string, args ...interface{}) *ClusterError {
	return &ClusterError{
...
func DeleteCluster(msg string, args ...interface{}) *ClusterError {
	return &ClusterError{
