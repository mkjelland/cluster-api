...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProviderStatusSource) DeepCopyInto(out *ProviderStatusSource) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProviderStatusSource.
func (in *ProviderStatusSource) DeepCopy() *ProviderStatusSource {
	if in == nil {
		return nil
	}
	out := new(ProviderStatusSource)
